    ...
    >
      ...
      <div className="relative md:hidden">
        <svg
          ...
          fill="none"
        >
          <path fill="currentColor" fillRule="evenodd" d="M12 3a3.836 3.836 0 0 0-3.844 3.828v1.345H5.143A1.14 1.14 0 0 0 4 9.31v10.552A1.14 1.14 0 0 0 5.143 21h13.714A1.14 1.14 0 0 0 20 19.862V9.31a1.14 1.14 0 0 0-1.143-1.137h-3.012V6.828A3.836 3.836 0 0 0 12 3m2.39 6.62v1.346c0 .4.326.724.727.724a.726.726 0 0 0 .728-.724V9.62h2.7v9.93H5.456v-9.93h2.701v1.345c0 .4.326.724.728.724a.726.726 0 0 0 .727-.724V9.62zm0-1.447V6.828c0-1.314-1.07-2.38-2.39-2.38a2.385 2.385 0 0 0-2.39 2.38v1.345z" clipRule="evenodd">
          </path>
        </svg>
